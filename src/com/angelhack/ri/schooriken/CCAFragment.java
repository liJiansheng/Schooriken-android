 ...
 *
 */
public class CCAFragment extends Fragment {
	...
	private ScrollView fragMain;
	private RelativeLayout fragCircle;
    /** (non-Javadoc)
     * @return 
    ...
    public void onActivityCreated(Bundle SavedInstanceState)
    {
    	...
    	fragMain = ((ScrollView)(getActivity().findViewById(R.id.fragMain)));
    	fragCircle = ((RelativeLayout)(getActivity().findViewById(R.id.fragCircle)));
	...
	private void showProgress(final boolean show) {
		...
		if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB_MR2) {
			...
			fragMain.setVisibility(show?View.VISIBLE:View.GONE);
			fragCircle.setVisibility(show?View.GONE:View.VISIBLE);
    ...
    private class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
		...
		protected Boolean doInBackground(Void... params) {
			...
			try {
				Log.d("ABC",myUsername+","+mPassword+","+"nongroup");
			...
			if (success) {
				try {
					...
					for(int i=0;i<totJSONData.length();i++){
						...
						if(tmpArr.getString("type").equals("CCA")){
							Log.d("CCA","Here5");
